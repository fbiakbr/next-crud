            ...
            <tbody className="bg-gray-200">
                <tr className="bg-gray-50 text-center">
                    <td className="px-16 py-2 flex flex-row items-center">
                        <img src="" alt="" />
                        <span className="text-center ml-2 font-semibold">Febiadi</span>
                    </td>
                    <td className="px-16 py-2">
                        <span>fbiakbr@gmail.com</span>
                    </td>
                    <td className="px-16 py-2">
                        <span>$576</span>
                    </td>
                    ...
                    <td className="px-16 py-2 flex justify-around gap-5">
                        ...
                        <button className="cursor"><BiTrashAlt size={25} color={"rgb(255,59,48)"} /></button>
                    </td>
                </tr>
            </tbody>
        </table>
